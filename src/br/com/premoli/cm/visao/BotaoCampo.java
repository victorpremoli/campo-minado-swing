...
import br.com.premoli.cm.modelo.Campo;
import br.com.premoli.cm.modelo.CampoEvento;
import br.com.premoli.cm.modelo.CampoObservador;
...
public class BotaoCampo extends JButton implements CampoObservador, MouseListener {
	...
	private void alicarEstiloPadrao() {
		setBackground(BG_PADRAO);
		setBorder(BorderFactory.createBevelBorder(0));
		setText("");
	}
